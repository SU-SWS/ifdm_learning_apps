...
import { FaArrowTrendDown, FaAngleDown, FaArrowTrendUp } from "react-icons/fa6";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            >
              <ChevronRight className={`h-5 w-5 transition-transform ${showBreakdown ? "rotate-90" : ""}`} />
              Year by Year
            </Button>
          </div>
        ...
        {/* Mode Selection */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Solve for:</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Button
              variant={mode === "monthly-savings" ? "default" : "outline"}
              className={`h-16 ${mode === "monthly-savings" ? "bg-teal-600 hover:bg-teal-700" : ""}`}
            ...
            <Button
              ...
              className={`h-16 ${mode === "time-to-goal" ? "bg-teal-600 hover:bg-teal-700" : ""}`}
            ...
            <Button
              ...
              className={`h-16 ${mode === "future-balance" ? "bg-teal-600 hover:bg-teal-700" : ""}`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <p className="text-sm text-gray-600">Enter your savings information</p>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Select value={compounding} onValueChange={(value: CompoundingFrequency) => setCompounding(value)}>
            ...
            <CardContent className="p-6">
              {mode === "monthly-savings" && (
                <div className="text-center mb-6">
                  <h3 className="text-lg font-medium text-gray-700 mb-2">Required monthly contribution:</h3>
              ...
              <div className="mt-6 p-4 bg-teal-50 rounded-lg border border-teal-200">
                ...
                <p className="text-sm text-teal-700">See how your savings grow over time</p>
              </div>
            </CardContent>
          </Card>
        </div>
