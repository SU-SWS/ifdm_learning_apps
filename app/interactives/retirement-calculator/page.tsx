          ...
          <div className="space-y-8">
            ...
            {activeTab === "balance" ? (
              <>
                ...
                <div className="mb-4">
                  <p className="font-semibold">Step 1: Estimate the required retirement balance</p>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <InfoPopover title="Enter annual spending in today&apos;s dollars">
                      Enter annual spending in today&apos;s dollars. To account for inflation, adjust the rate entered in the &quot;expected annual return during retirement&quot; field. For example, if expecting a 6% nominal return and 3% inflation, use a 3% real return.
                    </InfoPopover>
                  </div>
              ...
              <>
                ...
                <div className="mb-4">
                  <p className="font-semibold">Step 2: Calculate savings needed to reach the required balance</p>
                </div>
                  ...
                  {frozenRequiredBalance > 0 ? (
                    <>
                      {results.fvCurrentSavings >= results.requiredBalance ? (
                        <>
                          <p className="text-sm">
                            With an expected {inputs.expectedReturnBeforeRetirement}% annual return, the current retirement savings of {formatCurrency(inputs.currentSavings)} are projected to {results.fvCurrentSavings > results.requiredBalance ? "exceed" : "reach"} the target retirement balance with no additional contributions.
                          </p>
                          {results.fvCurrentSavings > results.requiredBalance && (
                          ...
                          <div className="flex gap-3 mt-4">
                            <button
                              onClick={() => {
                                setFrozenRequiredBalance(results.requiredBalance)
                    ...
                    <div className="p-4 rounded-lg bg-gray-50 border border-gray-200">
                      <p className="text-sm text-gray-700">
                        The required retirement balance will appear here. Enter annual retirement spending, expected retirement length (years), and expected annual return during retirement, then select Calculate.
                      </p>
                    </div>
                  )}
                </div>
                  ...
                  {results.fvCurrentSavings >= results.requiredBalance ? (
                    ...
                    <>
                      ...
                      <div className="mt-6 pt-6 border-t border-gray-200">
                        <p className="font-bold text-lg mb-4">Savings at Different Frequencies</p>
                        <div className="space-y-3">
                          <div className="flex justify-between items-center">
                            <span className="text-sm">Monthly</span>
                            <span className="font-semibold text-lagunita">{formatCurrency(results.monthlySavings)}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-sm">Bi-weekly</span>
                            <span className="font-semibold text-lagunita">{formatCurrency(results.biWeeklySavings)}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-sm">Weekly</span>
                            <span className="font-semibold text-lagunita">{formatCurrency(results.weeklySavings)}</span>
                          </div>
                        </div>
                      </div>
                    </>
