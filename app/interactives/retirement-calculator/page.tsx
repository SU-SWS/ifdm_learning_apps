...
export default function RetirementCalculator() {
  ...
  const [errors, setErrors] = useState<
    Partial<Record<keyof CalculatorInputs, string>>
  >({});
  ...
  const calculatedRequiredBalance = useMemo(() => {
    ...
    inputs.annualSpending,
    inputs.retirementLength,
    inputs.expectedReturnDuringRetirement,
  ]);
  ...
  const updateInput = (key: keyof CalculatorInputs, value: string) => {
    ...
    if (key === "expectedReturnBeforeRetirement") {
      ...
      setErrors((prev) => ({
        ...prev,
        expectedReturnBeforeRetirement: validation.error,
      }));
      setWarnings((prev) => ({
        ...prev,
        expectedReturnBeforeRetirement: validation.warning,
      }));
    ...
    if (key === "expectedReturnDuringRetirement") {
      ...
      setErrors((prev) => ({
        ...prev,
        expectedReturnDuringRetirement: validation.error,
      }));
      setWarnings((prev) => ({
        ...prev,
        expectedReturnDuringRetirement: validation.warning,
      }));
    ...
    if (key === "retirementLength") {
      ...
      setWarnings((prev) => ({
        ...prev,
        retirementLength: validation.warning,
      }));
    ...
    if (balanceInputs.includes(key)) {
      const spendingVal =
        key === "annualSpending" ? numValue : inputs.annualSpending;
      const lengthVal =
        key === "retirementLength" ? numValue : inputs.retirementLength;
      const rateVal =
        key === "expectedReturnDuringRetirement"
          ? numValue / 100
          : inputs.expectedReturnDuringRetirement / 100;

      setFrozenRequiredBalance(
        Math.round(calculateRequiredBalance(spendingVal, lengthVal, rateVal)),
      );
    }
  };
            ...
            {activeTab === "balance" ? (
              <>
                ...
                <div key="annual-spending-field" className="space-y-2">
                      ...
                      onBlur={(e) => {
                        ...
                        if (e.target.value === "") {
                          setErrors((prev) => ({
                            ...prev,
                            annualSpending:
                              "Please enter how much you plan to spend each year in retirement.",
                          }));
                        }
                      }}
                  ...
                  {errors.annualSpending ? (
                    <p
                      id="annual-spending-error"
                      role="alert"
                      className="text-sm text-[var(--color-inline-error)]"
                    >
                      {errors.annualSpending}
                    </p>
                  ) : (
                ...
                <div key="retirement-length-field" className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        updateInput(
                          "retirementLength",
                          capDecimalPlaces(e.target.value),
                        )
                      }
                      onFocus={() => {
                        setIsRetirementLengthFocused(true);
                        if (retirementLengthInput === "") {
                          setErrors((prev) => ({
                            ...prev,
                            retirementLength: undefined,
                          }));
                        }
                      }}
                      onBlur={(e) => {
                        ...
                        if (e.target.value === "") {
                          setErrors((prev) => ({
                            ...prev,
                            retirementLength:
                              "Please enter how many years your retirement will last.",
                          }));
                        }
                      }}
                      className={`${baseInputClass} pl-4 pr-16 ${inputStateClass(errors.retirementLength, !isRetirementLengthFocused ? warnings.retirementLength : undefined)}`}
                    />
                    <span
                      aria-hidden="true"
                  ...
                  {errors.retirementLength ? (
                    ...
                    <p
                      ...
                      role="status"
                      className="text-sm text-[var(--color-inline-warning)]"
                    >
                      {warnings.retirementLength}
                    </p>
                  ) : (
                ...
                <div key="return-during-retirement-field" className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <InfoPopover title="Expected annual return during retirement">
                      ...
                      rate. For example, if expecting a 6% nominal return, and
                      3% inflation, use a 3% real return.
                    </InfoPopover>
                  </div>
                  <div className="relative">
                    <input
                      ...
                      onFocus={() => {
                        if (expectedReturnDuringRetirementInput === "") {
                          setErrors((prev) => ({
                            ...prev,
                            expectedReturnDuringRetirement: undefined,
                          }));
                        }
                      }}
                      onBlur={(e) => {
                        if (e.target.value === "") {
                          setErrors((prev) => ({
                            ...prev,
                            expectedReturnDuringRetirement:
                              "Please enter an expected annual return rate.",
                          }));
                        }
                      }}
                  ...
                  {errors.expectedReturnDuringRetirement ? (
                    <p
                      id="return-during-retirement-error"
                      role="alert"
                      className="text-sm text-[var(--color-inline-error)]"
                    >
                      {errors.expectedReturnDuringRetirement}
                    ...
                    <p
                      id="return-during-retirement-warning"
                      role="status"
                      className="text-sm text-[var(--color-inline-warning)]"
                    >
                      {warnings.expectedReturnDuringRetirement}
                ...
                <div key="years-to-retirement-field" className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      aria-describedby={
                        errors.yearsToRetirement
                          ? "years-to-retirement-error"
                          : undefined
                      }
                      aria-invalid={!!errors.yearsToRetirement}
                      ...
                      onBlur={(e) => {
                        if (e.target.value === "") {
                          setErrors((prev) => ({
                            ...prev,
                            yearsToRetirement:
                              "Please enter how many years until you plan to retire.",
                          }));
                      ...
                      className={`${baseInputClass} pl-4 pr-16 ${inputStateClass(errors.yearsToRetirement)}`}
                    />
                    <span
                      aria-hidden="true"
                      className="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--color-symbols)] pointer-events-none"
                ...
                <div key="return-before-retirement-field" className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <InfoPopover title="Expected annual return before retirement">
                      ...
                      retirement. To account for inflation, use a real return.
                      For example, if expecting a 8% nominal return, and 3%
                      inflation, use a 5% real return.
                    </InfoPopover>
                  </div>
                  <div className="relative">
                    <input
                      ...
                      aria-invalid={!!errors.expectedReturnBeforeRetirement}
                      ...
                      onFocus={() => {
                        if (expectedReturnBeforeRetirementInput === "") {
                          setErrors((prev) => ({
                            ...prev,
                            expectedReturnBeforeRetirement: undefined,
                          }));
                        }
                      }}
                      onBlur={(e) => {
                        if (e.target.value === "") {
                          setErrors((prev) => ({
                            ...prev,
                            expectedReturnBeforeRetirement:
                              "Please enter an expected annual return rate before retirement.",
                          }));
                        }
                      }}
                      className={`${baseInputClass} pl-4 pr-16 ${inputStateClass(errors.expectedReturnBeforeRetirement, warnings.expectedReturnBeforeRetirement)}`}
                    />
                    <span
                      aria-hidden="true"
                      className="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--color-symbols)] pointer-events-none"
                  ...
                  {errors.expectedReturnBeforeRetirement ? (
                    <p
                      id="return-before-retirement-error"
                      role="alert"
                      className="text-sm text-[var(--color-inline-error)]"
                    >
                      {errors.expectedReturnBeforeRetirement}
                    ...
                    <p
                      id="return-before-retirement-warning"
                      role="status"
                      className="text-sm text-[var(--color-inline-warning)]"
                    >
                      {warnings.expectedReturnBeforeRetirement}
